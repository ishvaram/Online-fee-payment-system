...
<body style="background-color:#GCC;" >
...
<input style="margin-left:4cm;" type="submit" name="login1" value="LOGIN">
</form>
</div>
...
<br/>
<input style="margin-left:5.0cm;" type="submit" value="LOGIN" name="login2"><br/><br/>
<i style=" color:red;">Invalid Roll Number Or FEE alredy paid </i>
</form>
</div>
';
?>
